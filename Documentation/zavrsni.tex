...
The position of the table is being detected, and the possibility of extracting the content of each individual cell is offered, so that it can be used for further detection.
